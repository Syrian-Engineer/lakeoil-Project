...
export async function GET(req: Request) {
  try {
    ...
    const urls = {
      pumps: 'http://78.189.54.28:5000/station/pumps',
      tanks: 'http://78.189.54.28:5000/station/tanks',
      nozzles: 'http://78.189.54.28:5000/station/nozzles',
      products: 'http://78.189.54.28:5000/station/products',
    };
