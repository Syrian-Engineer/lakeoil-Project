...
//     try {
//       const response = await fetch(`${backendUrl}/sales_reports/periodic/current_month`, {
//         method: "POST",
//         headers: {
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${backendUrl}/sales_reports/periodic/current_month`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    console.error("Error in current month route:", error?.message || error);
