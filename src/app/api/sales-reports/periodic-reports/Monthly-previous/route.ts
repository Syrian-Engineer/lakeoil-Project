...
//     try {
//       const response = await fetch(`${backendUrl}/sales_reports/periodic/previous_month`, {
//         method: "POST",
//         headers: {
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${backendUrl}/sales_reports/periodic/previous_month`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    console.error("Error in periodic report route:", error?.message || error);
