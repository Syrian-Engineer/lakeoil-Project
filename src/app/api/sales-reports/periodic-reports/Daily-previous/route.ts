...
//     try {
//       const response = await fetch(`${backendUrl}/sales_reports/periodic/previous_day`, {
//         method: "POST",
//         headers: {
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${backendUrl}/sales_reports/periodic/previous_day`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    console.error("Error in previous day route:", error?.message || error);
