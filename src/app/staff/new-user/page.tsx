...
type AddUserFormValues = {
  ...
  password: string;
  role: string;
  associated_station: string;
};

const roles = [
  { label: 'Technician', value: 'Technician', id: '1' },
  { label: 'Manager', value: 'Manager', id: '2' },
  { label: 'Operator', value: 'Operator', id: '3' },
];
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        {...register('associated_station', { required: 'Station is required' })}
