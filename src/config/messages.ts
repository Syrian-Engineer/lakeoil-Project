export const messages = {
  ...
  startingTypeIsRequired:"fef",
  listingUnitIsRequired:"Fefe",
  propertyForIsRequired:"fefe",
  priceTypeIsRequired:"fefe",
  totalPriceIsRequired:"fefe",
  pricePerSquareRequired:"fefef",
